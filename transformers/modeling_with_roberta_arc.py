...
class RobertaForMultipleChoice(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        h = config.hidden_size + 600
        self.num_relations = kg.kg_embeddings['rel_metrices'].shape
        self.num_entities = kg.kg_embeddings['ent_embeddings'].shape

        self.n_embd = config.hidden_size
        self.gmatch = Gmatch(config, kg)
        self.EntAttn = Entity_Attn()
